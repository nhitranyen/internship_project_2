            ...
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input name="device_code" value="{{ old('device_code') }}"  type="text" class="form-control" placeholder="Nhập mã thiết bị">
                  @error('device_code')
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input name="device_name" value="{{ old('device_name') }}" type="text" class="form-control" placeholder="Nhập tên thiết bị">
                  @error('device_name')
                    <div class="text-danger">{{ $error }}</div>
                  @enderror
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input name="device_username" value="{{ old('device_username') }}" type="text" class="form-control" placeholder="Nhập tên đăng nhập">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input name="device_id" value="{{ old('device_id') }}" type="text" class="form-control" placeholder="Nhập địa chỉ IP" autocomplete="off">
                  @error('device_id')
                    <div class="text-danger">{{ $error }}</div>
                  @enderror
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input name="device_password" value="{{ old('device_password') }}" type="password" class="form-control" placeholder="Nhập mật khẩu" autocomplete="off">
                ...
                <div class="form-group col-md-12" style="border: none;">
                  ...
                  <div class="mb-30 ">
                    <input name="device_title" value="{{ old('device_title') }}" type="text" value="" class="" data-role="tagsinput" placeholder="Nhập dịch vụ sử dụng">
                    @error('device_title')
                      <div class="text-danger">{{ $error }}</div>
                    @enderror
                  </div>
